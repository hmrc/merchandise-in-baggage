...
@Singleton
class DeclarationBERepository @Inject()(mongo: () => DB)
  extends ReactiveRepository[DeclarationBE, String]("declaration-BE", mongo, DeclarationBE.format, implicitly[Format[String]]) {
